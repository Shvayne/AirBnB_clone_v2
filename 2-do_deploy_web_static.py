...
def do_deploy(archive_path):
    ...
    try:
        ...
        if put(archive_path, "/tmp/{}".format(remPath)).failed is True:
        ...
        if run("mv /data/web_static/releases/{}/web_static/* /data/web_static/releases/{}".format(remExt, remExt)).failed is True:
